...
graph TD
    ...
    ResponseFlow --> FlowMermaid["Mermaid flowchart diagram"]
    ...
    Root --> Footer["Generated by TelemetryFlow Hermes Agent"]
```
...
graph TD
    ...
    Resolution --> RemediationFlow["Remediation Flow<br/>Mermaid flowchart diagram"]
    Root --> Lessons["Lessons Learned"]
    Lessons --> WentWell["What Went Well"]
    Lessons --> Improve["What Could Be Improved"]
    Lessons --> Lucky["Where We Got Lucky"]
    ...
    Root --> Footer["Postmortem generated by TelemetryFlow Hermes Agent"]
```
